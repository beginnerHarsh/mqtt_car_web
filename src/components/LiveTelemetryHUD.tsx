...
export const LiveTelemetryHUD: React.FC<LiveTelemetryHUDProps> = ({
  ...
  return (
    <div className="absolute right-6 bottom-24 z-20 w-72 bg-slate-900/90 backdrop-blur-xl text-white rounded-2xl shadow-2xl border border-slate-700/70 overflow-hidden font-sans transition-all duration-300">
      {/* HUD Header Bar */}
      <div
